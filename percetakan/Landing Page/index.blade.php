  ...
  <body>
    ...
    <header id="header" class="fixed-top">
      <div class="container d-flex align-items-center justify-content-between">
        <h1 class="logo"><a href="index.html">Nyetak</a></h1>
      ...
      <section id="counts" class="counts section-bg">
        <div class="container">
          <div class="row justify-content-end">
            <div
              class="col-lg-4 col-md-5 col-6 d-md-flex align-items-md-stretch"
            >
              <div class="count-box">
                <span
    ...
    <footer id="footer">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-3 col-md-6 footer-contact">
              <h3>Nyetak</h3>
              <p>
                Jl. Raya Lenteng Agung <br />
                Jakarta<br />
                Indonesia <br /><br />
                <strong>Phone:</strong> +62 858 5432 4321<br />
                <strong>Email:</strong> nyetakyuk@gmail.com<br />
              </p>
            </div>
      ...
      <div class="container d-md-flex py-4">
        <div class="me-md-auto text-center text-md-start">
          <div class="copyright">
            &copy; Copyright <strong><span>Nyetak</span></strong
            >. All Rights Reserved
          </div>
          <div class="credits">
