    ...
    <div class="container px-5 my-5">
        <form method="POST" action="{{ route('barang.update', $row->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-floating mb-3">
                <input class="form-control" name="kode" value="{{ $row->kode }}" id="kodebarang" type="text"
            ...
            <div class="form-floating mb-3">
                <input class="form-control" name="nama_barang" value="{{ $row->nama_barang }}" id="barang" type="text"
