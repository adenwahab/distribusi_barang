        ...
        <form method="POST" action="{{ route('barang.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-floating mb-3">
                <input class="form-control" name="kode" value="" id="kodebarang" type="text"
                    placeholder="Kode barang" data-sb-validations="required" />
            ...
            <div class="form-floating mb-3">
                <input class="form-control" name="harga" value="" id="harga" type="text" placeholder="Harga"
                    data-sb-validations="required" />
                <label for="harga">Harga</label>
                <div class="invalid-feedback" data-sb-feedback="harga:required">Harga is required.</div>
            </div>
            <div class="form-floating mb-3">
                <input class="form-control" name="harga_member" value="" id="harga_member" type="text"
                    placeholder="Harga_member" data-sb-validations="required" />
                <label for="harga_member">Harga Member</label>
                <div class="invalid-feedback"></div>
            </div>
            <div class="form-floating mb-3">
                <input class="form-control" name="stok" value="" id="stok" type="text" placeholder="Stok"
                    data-sb-validations="required" />
                <label for="stok">Stok</label>
                <div class="invalid-feedback" data-sb-feedback="stok:required">Stok is required.</div>
            </div>
            <div class="form-floating mb-3">
                <input class="form-control" name="satuan" value="" id="satuan" type="text" placeholder="Satuan"
                    data-sb-validations="required" />
